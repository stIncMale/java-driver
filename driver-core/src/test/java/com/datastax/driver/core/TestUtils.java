...
public abstract class TestUtils {
    ...
    public static Host findHostWithin(Cluster cluster, int node, long duration, TimeUnit unit) {
        return findHostWithin(cluster, CCMBridge.ipOfNode(node), duration, unit);
    }

    public static Host findHostWithin(final Cluster cluster, final String address, long duration, TimeUnit unit) {
